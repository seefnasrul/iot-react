...
class Main extends React.Component {
    ...
    componentDidMount() {
        ...
        //             loadjs('assets/js/pages/widgets.js',function(){
        //                 loadjs('assets/plugins/custom/datatables/datatables.bundle.js');
        //             });
        //           });
        //     });
        // });
        // appendScript('assets/plugins/global/plugins.bundle.js');
        // appendScript('assets/plugins/custom/prismjs/prismjs.bundle.js');
        // appendScript('assets/js/scripts.bundle.js');
        // appendScript('assets/plugins/custom/fullcalendar/fullcalendar.bundle.js');
        // appendScript('assets/js/pages/widgets.js');
        // appendScript('assets/plugins/custom/datatables/datatables.bundle.js');
        ...
        return (
            ...
            <div className="d-flex flex-column flex-root">
                ...
                <div className="d-flex flex-row flex-column-fluid page">
                    {/* <!--begin::Aside--> */}
                    <div className="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside" style={{zIndex:1000}}>
                        {/* <!--begin::Brand--> */}
                        ...
                        {/* <!--end::Brand--> */}
                        {/* <!--begin::Aside Menu--> */}
                        <div className="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper" style={{zIndex:'9999'}}>
                            {/* <!--begin::Menu Container--> */}
                            <div id="kt_aside_menu" className="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style={{zIndex:'99999'}}>
                                {/* <!--begin::Menu Nav--> */}
                                <ul className="menu-nav">
                                   

                                    <li className={"menu-item "+(this.props.route === '/dashboard' ? "menu-item-active" : "") } aria-haspopup="true">
                                ...
                                <div className="topbar">
                                    ...
                                    <div className="dropdown">
                                        ...
                                        <div className="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                            <form>
                                                {/* <!--begin::Header--> */}
                                                <div className="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style={{backgroundImage: `url(${require("../assets_copy/media/misc/bg-1.jpg")})` }}>
                                                    {/*I<!--be'gin::Title--> */}
                                    ...
                                    <div className="topbar-item">
                                        <div className="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle" onClick={this.toggle_user_bar}>
            ...
            {/* // <!--end::Main--> */}
            {/* // <!-- begin::User Panel--> */}
            <div className={c("offcanvas offcanvas-right p-10",[{'offcanvas-on':this.state.show_user_bar}])}>
                {/* <!--begin::Header--> */}
                <div className="offcanvas-header d-flex align-items-center justify-content-between pb-5">
                    ...
                    <a href="#" className="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_user_close" onClick={this.toggle_user_bar}>
                ...
                <div className="offcanvas-content pr-5 mr-n5">
                    ...
                    <div className="d-flex align-items-center mt-5">
                        <div className="symbol symbol-100 mr-5">
                            <div className="symbol-label" style={{backgroundImage:`url(${require("../assets_copy/media/users/300_21.jpg")})`}}></div>
                        ...
                        <div className="d-flex flex-column">
                            ...
                            <div className="navi mt-2">
                                ...
                                <a href="#" className="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5" onClick={this.logout}>Sign Out</a>
                            </div>
                        </div>
                    </div>
                    {/* <!--end::Header--> */}
            ...
            {
                this.state.show_user_bar &&
                <div className="offcanvas-overlay" onClick={this.toggle_user_bar}></div>
            }
            ...
            //                 </li>
            //                 <li>
            //                     <Link to="#" data-toggle="search" className="nav-link nav-link-lg d-sm-none">
            ...
            //                     <div className="d-sm-none d-lg-inline-block">Hi, {this.props.user_data.last_name}</div>
            //                 </Link>
            ...
            //                     <a className="dropdown-item has-icon text-danger" onClick={this.logout}>
            ...
            //                     this.props.route === '/tryouts' ||
            //                     this.props.route === '/tryout/:quid' ||
            //                     this.props.route === '/pakets' ||
            //                     this.props.route === '/paket/:slug' ? "active" : null)
            //                 }>
            //                     <Link to="/dashboard" className="nav-link">
            //                         <i className="fas fa-fire"/><span>Dashboard</span>
            //                     </Link>
            //                 </li>
            //                 <li className={"nav-item dropdown " + (this.props.route === '/paketmu' ? "active" : null)}>
            //                     <Link to="/paketmu" className="nav-link">
            //                         <i className="fas fa-book"/><span>Paket Milikmu</span>
            //                     </Link>
            //                 </li>
            //                 <li className={"nav-item dropdown " + (this.props.route === '/order-history' ? "active" : null)}>
            //                     <Link to="/order-history" className="nav-link">
            //                         <i className="fas fa-file-invoice"/><span>Riwayat Pembelian</span>
            //                     </Link>
            //                 </li>
            //                 <li className={"nav-item dropdown " + (this.props.route === '/result/:rid' || this.props.route === '/results' ? "active" : null)}>
            //                     <Link to="/results" className="nav-link">
            //                         <i className="fas fa-graduation-cap"/><span>Hasil Ujian</span>
            //                     </Link>
            //                 </li>
            //             </ul>
            //         </aside>
